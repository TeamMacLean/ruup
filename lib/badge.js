...
Badge.upPercent = (siteName, percent) => {
    // return generate(siteName + ' uptime', percent + '%', colorForPercent(percent))
...
Badge.averageResponseTime = (siteName, average) => {
    // return generate(siteName + ' avg response time', average + 'ms', colorForResponseTime(average))
    return generate('avg response time', average + 'ms', colorForResponseTime(average))
};
